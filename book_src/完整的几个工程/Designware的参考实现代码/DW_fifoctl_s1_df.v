...
//           true dual port RAMs. "rtl" implementation.
//
...
input  [`DW_addr_width-1:0]	ae_level;	// Almost empty level input bus
input  [`DW_addr_width-1:0]	af_thresh;	// Almost full threshold input bus
...
wire nxt_empty_n_nc, nxt_full_nc, nxt_error_nc;
    ...
    DWsc_fifoctl_s1_df #(depth, err_mode, `DW_addr_width, 0) U1(
        .clk(clk),
        .rst_n(a_rst_n),
        .init_n(s_rst_n),
